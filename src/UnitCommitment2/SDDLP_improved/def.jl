...
mutable struct CurrentInfo
    x            :: Dict{Symbol, Dict{Int64, Any}}                  ## record x point
    f            :: Float64                                         ## record f(x_j)
    G            :: Dict{Int64, Float64} 
    df           :: Dict{Symbol, Dict{Int64, Any}}
    dG           :: Dict{Int64, Dict{Symbol, Dict{Int64, Any}}}     ## actually is a matrix.  But we use dict to store it
end
...
struct ModelInfo
    ...
    sur   :: JuMP.Containers.SparseAxisArray{VariableRef}
    y     :: VariableRef
    z     :: VariableRef
end
