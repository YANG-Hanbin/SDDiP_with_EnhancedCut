...
(probList, 
            stageDataList, 
            Ω, 
            binaryInfo) = dataGeneration(; T = T , initial_demand = 1e6, seed = 123, num_Ω = 2)
...
save("src/GenerationExpansion/3.0version_Integer/testData_2/stageDataList.jld2", "stageDataList", stageDataList)
save("src/GenerationExpansion/3.0version_Integer/testData_2/Ω.jld2", "Ω", Ω)
save("src/GenerationExpansion/3.0version_Integer/testData_2/binaryInfo.jld2", "binaryInfo", binaryInfo)
save("src/GenerationExpansion/3.0version_Integer/testData_2/scenario_sequence.jld2", "scenario_sequence", scenario_sequence)
save("src/GenerationExpansion/3.0version_Integer/testData_2/probList.jld2", "probList", probList)
