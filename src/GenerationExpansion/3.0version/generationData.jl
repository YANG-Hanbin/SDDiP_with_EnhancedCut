...
save("src/GenerationExpansion/3.0version/testData_15/stageDataList.jld2", "stageDataList", stageDataList)
save("src/GenerationExpansion/3.0version/testData_15/Ω.jld2", "Ω", Ω)
save("src/GenerationExpansion/3.0version/testData_15/binaryInfo.jld2", "binaryInfo", binaryInfo)
save("src/GenerationExpansion/3.0version/testData_15/scenario_sequence.jld2", "scenario_sequence", scenario_sequence)
save("src/GenerationExpansion/3.0version/testData_15/probList.jld2", "probList", probList)
