...
stageDataList = load("src/GenerationExpansion/3.0version/testData_8/stageDataList.jld2")["stageDataList"]
Ω = load("src/GenerationExpansion/3.0version/testData_8/Ω.jld2")["Ω"]
binaryInfo = load("src/GenerationExpansion/3.0version/testData_8/binaryInfo.jld2")["binaryInfo"]
scenario_sequence = load("src/GenerationExpansion/3.0version/testData_8/scenario_sequence.jld2")["scenario_sequence"]
probList = load("src/GenerationExpansion/3.0version/testData_8/probList.jld2")["probList"]
