...
(probList, 
            stageDataList, 
            Ω, 
            binaryInfo) = dataGeneration(; T = 3 , initial_demand = 1e7, seed = 123)
...
save("src/GenerationExpansion/2.0version/testData/stageDataList.jld2", "stageDataList", stageDataList)
save("src/GenerationExpansion/2.0version/testData/Ω.jld2", "Ω", Ω)
save("src/GenerationExpansion/2.0version/testData/binaryInfo.jld2", "binaryInfo", binaryInfo)
save("src/GenerationExpansion/2.0version/testData/scenario_sequence.jld2", "scenario_sequence", scenario_sequence)
save("src/GenerationExpansion/2.0version/testData/probList.jld2", "probList", probList)
