...
function backward_Constraint_Modification!(backwardInfo::BackwardModelInfo, 
    ...
    @constraint(backwardInfo.model, binarizationConstraint, binaryInfo.A * sum_generator + backwardInfo.x .== binaryInfo.A * backwardInfo.Lt )               ## to ensure pass a binary variable for next stage
