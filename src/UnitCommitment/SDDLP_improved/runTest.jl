...
@everywhere begin
    ...
    med_method = "interval_mid"; # "exact_point", "interval_mid"
    ...
    T = 8; num = 10; case = "case30pwl"; # "case_RTS_GMLC", "case30", "case30pwl", "case24_ieee_rts"
end
...
T = 12; num = 10; cutSelection = "LC"; ℓ = 0.0;
if cutSelection == "ELC" 
...
q025 = quantile(sddlpResult.time, 0.025)
q975 = quantile(sddlpResult.time, 0.975)
...
# end
# round(sddlpResult.LB[size(sddlpResult)[1]], digits = 1)
# round(sddlpResult.UB[size(sddlpResult)[1]], digits = 1)
# q025 = quantile(sddlpResult.time, 0.025)
# q975 = quantile(sddlpResult.time, 0.975)
