...
@everywhere begin
    ...
    Output_Gap = false; max_iter = 150; MaxIter = 100; δ = .1; numScenarios = 100; tightness = true;  TimeLimit = 60 * 60 * 2.; OPT = Inf; case = "case30pwl"; # "case_RTS_GMLC", "case30", "case30pwl", "case24_ieee_rts"
