...
for T in [6, 8, 12]
    for num in [5, 10]
        sddlpResultLC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/multistage_stochastic_unit_commitment/logger/numericalResults-case30pwl/Periods$T-Real$num/$algorithm-LC.jld2")["sddpResults"][:solHistory]
        sddlpResultPLC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/multistage_stochastic_unit_commitment/logger/numericalResults-case30pwl/Periods$T-Real$num/$algorithm-PLC.jld2")["sddpResults"][:solHistory]
        sddlpResultSMC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/multistage_stochastic_unit_commitment/logger/numericalResults-case30pwl/Periods$T-Real$num/$algorithm-SMC.jld2")["sddpResults"][:solHistory]
        ...
        lbtime |> save("/Users/aaron/SDDiP_with_EnhancedCut/src/multistage_stochastic_unit_commitment/logger/numericalResults-case30pwl/Periods$T-Real$num/lower_bound_Time_Period$T-Real$num.pdf")
        ...
        # @df sddlpResultSMC plot!(:Time, :UB, linewidth=1, marker=(:hexagon, 2, 1.), label="", color=:orange)
        lbiter |> save("/Users/aaron/SDDiP_with_EnhancedCut/src/multistage_stochastic_unit_commitment/logger/numericalResults-case30pwl/Periods$T-Real$num/lower_bound_Iter_Period$T-Real$num.pdf")
        ...
        # @df sddlpResultSMC plot!(:Time, :UB, linewidth=1, marker=(:hexagon, 2, 1.), label="", color=:orange)
        gaptime |> save("/Users/aaron/SDDiP_with_EnhancedCut/src/multistage_stochastic_unit_commitment/logger/numericalResults-case30pwl/Periods$T-Real$num/gpa_Time_Period$T-Real$num.pdf")
        ...
        # @df sddlpResultSMC plot!(:Time, :UB, linewidth=1, marker=(:hexagon, 2, 1.), label="", color=:orange)
        gapiter |> save("/Users/aaron/SDDiP_with_EnhancedCut/src/multistage_stochastic_unit_commitment/logger/numericalResults-case30pwl/Periods$T-Real$num/gap_Iter_Period$T-Real$num.pdf")
    end
end
