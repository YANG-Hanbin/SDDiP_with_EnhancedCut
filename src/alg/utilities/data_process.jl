...
## ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- ##
# 初始化DataFrame
med_method = :ExactPoint # :ExactPoint, :IntervalMed
...
for cut in [:LC, :PLC, :SMC]
    for T in [6, 8, 12]
        for num in [5, 10]
            try
                # if cut == :PLC 
                #     file_path = "/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDPL-$cut-$med_method-0.0.jld2"
                # else
                #     file_path = "/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDPL-$cut-$med_method.jld2"
                # end
                # solHistory = load(file_path)["sddpResults"][:solHistory]

                file_path = "/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDiP-$cut-256.jld2"
                solHistory = load(file_path)["sddpResults"][:solHistory]

                # file_path = "/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDP-$cut.jld2"
                # solHistory = load(file_path)["sddpResults"][:solHistory]
...
for T in [6, 8, 12]
    for num in [5, 10]
        ...
        # 读取数据
        # sddlpResultLC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/$algorithm-LC.jld2")["sddpResults"][:solHistory]
        # sddlpResultPLC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/$algorithm-PLC.jld2")["sddpResults"][:solHistory]
        # sddlpResultSMC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/$algorithm-SMC.jld2")["sddpResults"][:solHistory]

        sddlpResultLC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/$algorithm-LC-$med_method.jld2")["sddpResults"][:solHistory]
        sddlpResultPLC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/$algorithm-PLC-$med_method-0.0.jld2")["sddpResults"][:solHistory]
        sddlpResultSMC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/$algorithm-SMC-$med_method.jld2")["sddpResults"][:solHistory]
        ...
        df |> @vlplot(
            ...
            y={:LB, axis={title="Lower bounds (× 10³)", titleFontSize=25, labelFontSize=25}, scale={domain=[0, 12]}},
            color={
                :Cut, 
        ...
        ) |> save("$(homedir())/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/lower_bound_Time_Period$T-Real$num-$med_method.pdf")


        sddlpResultLC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDPL-LC-$med_method.jld2")["sddpResults"][:solHistory]
        sddlpResultPLC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDPL-PLC-$med_method-0.0.jld2")["sddpResults"][:solHistory]
        sddlpResultSMC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDPL-SMC-$med_method.jld2")["sddpResults"][:solHistory]
        ...
        ) |> save("$(homedir())/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/lower_bound_Iter_Period$T-Real$num-$med_method.pdf")
    end
end
...
for T in [6, 8, 12]
    for num in [5, 10]
        ...
        sddlpResultLC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDiP-LC-256.jld2")["sddpResults"][:solHistory]
        sddlpResultPLC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDiP-PLC-256.jld2")["sddpResults"][:solHistory]
        sddlpResultSMC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDiP-SMC-256.jld2")["sddpResults"][:solHistory]
        ...
        ) |> save("$(homedir())/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/sddip-lower_bound_Time_Period$T-Real$num-$med_method.pdf")
        ...
        ) |> save("$(homedir())/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/sddip-lower_bound_Iter_Period$T-Real$num-$med_method.pdf")
    end
end
...
for T in [6, 8, 12]
    for num in [5, 10]
        ...
        sddlpResultLC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDP-LC.jld2")["sddpResults"][:solHistory]
        sddlpResultPLC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDP-PLC.jld2")["sddpResults"][:solHistory]
        sddlpResultSMC = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDP-SMC.jld2")["sddpResults"][:solHistory]
        ...
        ) |> save("$(homedir())/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/sddp-lower_bound_Time_Period$T-Real$num.pdf")
        ...
        ) |> save("$(homedir())/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/sddp-lower_bound_Iter_Period$T-Real$num.pdf")
    end
end
...
for T in [6, 8, 12]
    for num in [5, 10]
        for method in ["LC", "PLC", "SMC"]
            # 读取数据
            if method == "PLC" 
                data = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDPL-$method-$med_method-0.0.jld2")["sddpResults"][:solHistory]
            else
                data = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDPL-$method-$med_method.jld2")["sddpResults"][:solHistory]
            end
...
@vlplot(
    ...
    yError={"std_time:q"}
) |> save("$(homedir())/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/$algorithm-AverageIterTime-$med_method.pdf")
...
) |> save("$(homedir())/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/$algorithm-LMiter-$med_method.pdf")
...
for method in ["LC", "PLC", "SMC"]
    # 读取数据
    data = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDiP-$method-256.jld2")["sddpResults"][:solHistory]
...
for method in ["LC", "PLC", "SMC"]
    # 读取数据
    data = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/SDDP-$method.jld2")["sddpResults"][:solHistory]
...
) |> save("$(homedir())/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/AverageIterTime-$med_method.pdf")
...
) |> save("$(homedir())/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-$case/Periods$T-Real$num/LMiter-$med_method.pdf")
...
sddlpResult1 = load("/Users/aaron/SDDiP_with_EnhancedCut/src/alg/logger/numericalResults-case30pwl/Periods6-Real5/SDDPL-PLC-IntervalMed-1.0.jld2")["sddpResults"][:solHistory]
